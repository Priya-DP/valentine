// Three.js 3D Hearts Animation for Valentine's Page
...
function initThreeJS() {
  ...
  const heartColors = [0xff4081, 0xe040fb, 0xff6b9d, 0xd81b60];
  ...
  // Add point light
  const pointLight = new THREE.PointLight(0xff4081, 1, 100);
